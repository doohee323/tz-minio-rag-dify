...
<script>
// Chat is handled by chat-admin. Token from API (no i18n).
...
export default {
  name: 'ChatWidget',
  data() {
    const base = (process.env.VUE_APP_CHAT_GATEWAY_URL || 'http://localhost:8000').replace(/\/$/, '')
  ...
  mounted() {
    ...
    console.log(
      ...
      '\n  - VUE_APP_CHAT_GATEWAY_URL (optional, default: http://localhost:8000)',
