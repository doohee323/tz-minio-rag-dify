...
This document describes how to add the chat widget (as used in tz-cointutor) to another Vue project.
...
```bash
cp chat-admin/sample/ChatWidget.vue your-vue-app/src/components/ChatWidget.vue
```
